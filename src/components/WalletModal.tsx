            ...
            <div className="space-y-4">
              {!isManagerUnlocked ? (
                ...
                <form onSubmit={handleUnlock} className="py-4 text-right space-y-3.5 max-w-sm mx-auto">
                  ...
                  <div className="flex items-center justify-between text-[11px] text-slate-500 bg-slate-100 p-2.5 rounded-xl border border-slate-200">
                    <span>🔒 بيانات اعتماد الإدارة مشفرة ومحمية</span>
                    <span className="text-[10px] text-slate-400 font-medium">سري للغاية</span>
                  </div>
